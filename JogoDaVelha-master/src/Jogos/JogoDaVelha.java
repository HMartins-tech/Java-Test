...
public class JogoDaVelha extends javax.swing.JFrame {
	...
	public void JogadorVencedor(String Jogador) {
		...
		if (Botao1.getText().equals(Jogador) && Botao2.getText().equals(Jogador) && Botao3.getText().equals(Jogador)) {
		...
		if (Botao4.getText().equals(Jogador) && Botao5.getText().equals(Jogador) && Botao6.getText().equals(Jogador)) {
		...
		if (Botao7.getText().equals(Jogador) && Botao8.getText().equals(Jogador) && Botao9.getText().equals(Jogador)) {
		...
		if (Botao1.getText().equals(Jogador) && Botao4.getText().equals(Jogador) && Botao7.getText().equals(Jogador)) {
		...
		if (Botao2.getText().equals(Jogador) && Botao5.getText().equals(Jogador) && Botao8.getText().equals(Jogador)) {
		...
		if (Botao3.getText().equals(Jogador) && Botao6.getText().equals(Jogador) && Botao9.getText().equals(Jogador)) {
		...
		if (Botao1.getText().equals(Jogador) && Botao5.getText().equals(Jogador) && Botao9.getText().equals(Jogador)) {
		...
		if (Botao3.getText().equals(Jogador) && Botao5.getText().equals(Jogador) && Botao7.getText().equals(Jogador)) {
		...
		if (!Botao1.getText().equals("") && !Botao2.getText().equals("") && !Botao3.getText().equals("")
				&& !Botao4.getText().equals("") && !Botao5.getText().equals("") && !Botao6.getText().equals("")
				&& !Botao7.getText().equals("") && !Botao8.getText().equals("") && !Botao9.getText().equals("")) {
	...
	private void initComponents() {
		...
		Botao1.setFont(new java.awt.Font("Comic Sans MS", 0, 36));
		...
		Botao2.setFont(new java.awt.Font("Comic Sans MS", 0, 36));
		...
		Botao3.setFont(new java.awt.Font("Comic Sans MS", 0, 36));
		...
		Botao4.setFont(new java.awt.Font("Comic Sans MS", 0, 36));
		...
		Botao5.setFont(new java.awt.Font("Comic Sans MS", 0, 36));
		...
		Botao6.setFont(new java.awt.Font("Comic Sans MS", 0, 36));
		...
		Botao7.setFont(new java.awt.Font("Comic Sans MS", 0, 36));
		...
		Botao8.setFont(new java.awt.Font("Comic Sans MS", 0, 36));
		...
		Botao9.setFont(new java.awt.Font("Comic Sans MS", 0, 36));
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(15, 15, 15)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
								...
								.addComponent(Botao7, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
										javax.swing.GroupLayout.PREFERRED_SIZE))
						.addGap(18, 18, 18)
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(Botao2, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
										javax.swing.GroupLayout.PREFERRED_SIZE)
								.addComponent(Botao5, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
										javax.swing.GroupLayout.PREFERRED_SIZE)
						...
						.addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addGroup(jPanel1Layout.createSequentialGroup()
										.addComponent(Botao3, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
												javax.swing.GroupLayout.PREFERRED_SIZE)
								...
								.addGroup(jPanel1Layout.createSequentialGroup()
										.addGroup(jPanel1Layout
												...
												.addComponent(Botao9, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
														javax.swing.GroupLayout.PREFERRED_SIZE)
												.addComponent(Botao6, javax.swing.GroupLayout.PREFERRED_SIZE, 90,
														javax.swing.GroupLayout.PREFERRED_SIZE))
		...
		InfJogo.setFont(new java.awt.Font("Dialog", 1, 18));
		InfJogo.setText("Informações do Jogo");

		Jog1Simb.setFont(new java.awt.Font("Dialog", 1, 14));
		Jog1Simb.setText("Jogador 1            Simbolo: X");

		Jog1Vitoria.setFont(new java.awt.Font("Dialog", 1, 14));
		Jog1Vitoria.setText("Número de Vitórias: 0");

		Jog2Simb.setFont(new java.awt.Font("Dialog", 1, 14));
		Jog2Simb.setText("Jogador 2                  Simbolo: O");

		Jog2Vitoria.setFont(new java.awt.Font("Dialog", 1, 14));
		Jog2Vitoria.setText("Número de Vitórias: 0");

		NumEmpate.setFont(new java.awt.Font("Dialog", 1, 14));
		...
		jPanel3Layout.setHorizontalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup().addContainerGap().addGroup(jPanel3Layout
						.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
						.addComponent(jSeparator2, javax.swing.GroupLayout.Alignment.TRAILING).addComponent(jSeparator1)
						.addGroup(jPanel3Layout.createSequentialGroup()
								.addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
										.addComponent(InfJogo).addComponent(Jog1Simb).addComponent(Jog1Vitoria)
										.addComponent(Jog2Simb).addComponent(Jog2Vitoria).addComponent(NumEmpate))
								.addGap(0, 78, Short.MAX_VALUE)))
						.addContainerGap()));
		jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel3Layout.createSequentialGroup().addGap(12, 12, 12).addComponent(InfJogo)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(Jog1Simb)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(Jog1Vitoria)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(jSeparator1, javax.swing.GroupLayout.PREFERRED_SIZE, 10,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(Jog2Simb)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED).addComponent(Jog2Vitoria)
						.addGap(18, 18, 18)
						.addComponent(jSeparator2, javax.swing.GroupLayout.PREFERRED_SIZE, 10,
								javax.swing.GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED,
								javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
						.addComponent(NumEmpate).addContainerGap()));

		jPanel2.setBackground(new java.awt.Color(255, 255, 255));

		ControleJogo.setFont(new java.awt.Font("Dialog", 1, 14));
		...
		jPanel2Layout.setHorizontalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addContainerGap(15, Short.MAX_VALUE)
						.addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
								.addComponent(NovoJogo, javax.swing.GroupLayout.Alignment.TRAILING)
								.addComponent(SobreJogo, javax.swing.GroupLayout.Alignment.TRAILING,
		...
		jPanel2Layout.setVerticalGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
				.addGroup(jPanel2Layout.createSequentialGroup().addGap(12, 12, 12).addComponent(ControleJogo)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(NovoJogo)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(SobreJogo)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(SairJogo)
